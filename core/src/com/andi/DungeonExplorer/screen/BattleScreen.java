...
import com.andi.DungeonExplorer.battle.Battle.STATE;
import com.andi.DungeonExplorer.battle.Trainer;
import com.andi.DungeonExplorer.battle.event.BattleEvent;
import com.andi.DungeonExplorer.controller.BattleScreenController;
import com.andi.DungeonExplorer.screen.renderer.BattleDebugRenderer;
import com.andi.DungeonExplorer.screen.renderer.BattleRenderer;
...
public class BattleScreen extends AbstractScreen implements com.andi.DungeonExplorer.battle.event.BattleEventPlayer {
	...
	private com.andi.DungeonExplorer.ui.DetailedStatusBox playerStatus;
	...
	public BattleScreen(DungeonExplorer app) {
		super(app);
	...
	private void initUI() {
		...
		playerStatus = new com.andi.DungeonExplorer.ui.DetailedStatusBox(getApp().getSkin());
