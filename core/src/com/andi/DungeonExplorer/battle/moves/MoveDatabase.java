...
import com.andi.DungeonExplorer.battle.animation.ChargeAnimation;
	...
	private void initializeMoves() {
		addMove(new DamageMove(
				new MoveSpecification(
						com.andi.DungeonExplorer.battle.moves.MOVE_TYPE.NORMAL,
		...
		addMove(new DamageMove(
				new MoveSpecification(
						com.andi.DungeonExplorer.battle.moves.MOVE_TYPE.WATER,
		...
		addMove(new DamageMove(
				new MoveSpecification(
						com.andi.DungeonExplorer.battle.moves.MOVE_TYPE.DRAGON,
						MOVE_CATEGORY.PHYSICAL, 
						80, 
						1f, 
						15, 
