...
public class MultiplayerGameScreen extends AbstractScreen implements CutscenePlayer, CutsceneEventQueuer {
    ...
    public MultiplayerGameScreen(DungeonExplorer app, Account account) {
        super(app);
        ...
        worlds.put("snow_Map", WorldLoader.snowMultiplayerMap(app.getAssetManager(), this, this, rickAnimations));
        world = worlds.get("snow_Map");

        camera = new Camera();
        player = new PlayerActor(world, 31, 28, mortyAnimations);
