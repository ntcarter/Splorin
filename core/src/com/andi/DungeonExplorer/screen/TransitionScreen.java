...
public class TransitionScreen extends AbstractScreen {
	...
	private com.andi.DungeonExplorer.screen.transition.Action action;
	...
	public TransitionScreen(com.andi.DungeonExplorer.DungeonExplorer app) {
		super(app);
	...
	public void startTransition(AbstractScreen from, AbstractScreen to, Transition out, Transition in, com.andi.DungeonExplorer.screen.transition.Action action) {
		this.from = from;
		this.to = to;
